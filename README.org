...
* TODO Usage
These are my ideas about how I use my system.
** NixOS as a Desktop
...
#+begin_src nix
  ...
  systemd.user.services."hello-world" = {
    serviceConfig = {
      Type = "oneshot";
      ExecStart = "/etc/profiles/per-user/adham/bin/mbsync -Va; /etc/profiles/per-user/adham/bin/notmuch new > /tmp/notmuch.tmp";
    };
  };
#+end_src
